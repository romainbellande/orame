...
pub fn get_canvas_context(canvas: &mut web_sys::HtmlCanvasElement) -> web_sys::CanvasRenderingContext2d {
  canvas
        .get_context("2d")
        .unwrap()
        .unwrap()
...
pub fn scale_canvas(canvas: HtmlElement<Canvas>, context: CanvasRenderingContext2d, width: f64, height: f64) {
